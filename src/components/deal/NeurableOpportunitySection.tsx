...
/**
 * Custom Opportunity section for Neurable ONLY — Bullet list version.
 */
  ...
  <section className="py-12 sm:py-16 px-4 sm:px-6 bg-white">
    <div className="max-w-3xl mx-auto text-left">
      <div className="mb-6 sm:mb-8">
        <h3 className="text-xs sm:text-sm md:text-base font-semibold mb-3 sm:mb-4 text-sky-600 uppercase tracking-wide">
          The Opportunity
        </h3>
